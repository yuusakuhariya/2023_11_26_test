...
<div class="contact-form__content">
    ...
    <form class="form" action="/contacts/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__group-name__flame">
                <div class="form__group-name__inner-left">
                    <input class="input-name" type="name" name="first_name" value="{{ old('first_name') }}">
                ...
                <div class="form__group-name__inner-right">
                    <input class="input-name" type="name" name="last_name" value="{{ old('last_name') }}">
        ...
        <div class="form__group">
            ...
            <div class="form__group-postcode__flame">
                ...
                <div class="form__group-postcode__inner">
                    <input class="input-postcode" name="postcode" type="text" size="10" value="{{ old('postcode') }}" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');">
        ...
        <div class="form__group">
            ...
            <div class="form__input-inner">
                <input class="input-address" name="address"type="text" value="{{ old('address') }}" size="60">
        ...
        <div class="form__group">
            ...
            <div class="form__input-inner">
                <input class="input-building_name" type="text" name="building_name" value="{{ old('building_name') }}">
        ...
        <div class="form__group">
            ...
            <div class="form__input-inner">
                <div class="form__input-textarea">
                    <textarea name="opinion" cols="120">{{ old('opinion') }}</textarea>
                </div>
                <div class="name__error">
                @error('opinion')
                    {{ $message }}
